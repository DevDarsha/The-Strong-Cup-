      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
          <div className="space-y-8">
            <h1 className="text-4xl md:text-7xl font-serif font-bold text-tea-brown leading-tight">
              Our Story: <br />
            ...
            <div className="grid grid-cols-2 gap-8 pt-8">
              <div>
                <h4 className="text-3xl font-bold text-tea-brown">100%</h4>
                <p className="text-xs font-bold uppercase tracking-widest text-tea-brown/40">Pure Assam Tea</p>
              </div>
              <div>
                <h4 className="text-3xl font-bold text-tea-brown">0%</h4>
                <p className="text-xs font-bold uppercase tracking-widest text-tea-brown/40">Added Colors</p>
              </div>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -left-10 bg-tea-gold p-8 rounded-[2rem] shadow-2xl hidden md:block">
              <Award size={48} className="text-white mb-4" />
              <p className="text-white font-bold">Premium Quality <br /> Certified</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <div key={i} className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-tea-brown/5 text-center">
              <div className="w-16 h-16 bg-tea-gold/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <item.icon size={32} className="text-tea-gold" />
              </div>
              <h3 className="text-xl font-bold text-tea-brown mb-4">{item.title}</h3>
              <p className="text-tea-brown/50 text-sm leading-relaxed">{item.desc}</p>
            </div>
          ))}
        </div>

        <div className="bg-tea-brown rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-tea-cream mb-8">Ready to taste the difference?</h2>
            <p className="text-tea-cream/60 text-lg mb-12">Experience the real strength of pure Assam tea today.</p>
            <button 
              onClick={() => navigate('/shop')}
              className="bg-tea-gold text-tea-brown px-12 py-5 rounded-full font-bold text-lg hover:bg-white transition-all shadow-xl"
            >
              Shop Our Collection
